...
<section class="skills-details">
    <div class="panel-group" id="skills" role="tablist" aria-multiselectable="false">
        <div class="panel">
            <div class="page-header" role="tab" id="diseno">
                <h2>
                    <a role="button" data-toggle="collapse" data-parent="#skills" href="#listDiseno" aria-expanded="false" aria-controls="listDiseno" class="collapsed">
	    ...
	    <div class="panel">
		    <div class="page-header" role="tab" id="frontEnd">
			    <h2>
				    <a role="button" data-toggle="collapse" data-parent="#skills" href="#listFrontEnd" aria-expanded="false" aria-controls="listFrontEnd" class="collapsed">
					    Tecnologías FrontEnd <i class="fa fa-arrow-circle-down" aria-hidden="true"></i></a>
			    </h2>
		    </div>
		    <div class="panel-collapse collapse" id="listFrontEnd" role="tabpanel" aria-labelledby="frontEnd">
			    <div class="panel-body">
				    <?php
				    $args = array(
					    'post_type' => 'habilidades',
	    ...
	    <div class="panel">
		    <div class="page-header" role="tab" id="backend">
			    <h2>
				    <a role="button" data-toggle="collapse" data-parent="#skills" href="#listBackEnd" aria-expanded="false" aria-controls="listBackEnd" class="collapsed">
					    Tecnologías BackEnd <i class="fa fa-arrow-circle-down" aria-hidden="true"></i></a>
			    </h2>
		    </div>
		    <div class="panel-collapse collapse" id="listBackEnd" role="tabpanel" aria-labelledby="backend">
			    <div class="panel-body">
				    <?php
				    $args = array(
					    'post_type' => 'habilidades',
	    ...
	    <div class="panel">
		    <div class="page-header" role="tab" id="database">
			    <h2>
				    <a role="button" data-toggle="collapse" data-parent="#skills" href="#listBD" aria-expanded="false" aria-controls="listBD" class="collapsed">
					    Bases de Datos <i class="fa fa-arrow-circle-down" aria-hidden="true"></i></a>
			    </h2>
		    </div>
		    <div class="panel-collapse collapse" id="listBD" role="tabpanel" aria-labelledby="database">
			    <div class="panel-body">
				    <?php
				    $args = array(
					    'post_type' => 'habilidades',
	    ...
	    <div class="panel">
		    <div class="page-header" role="tab" id="cms">
			    <h2>
				    <a role="button" data-toggle="collapse" data-parent="#skills" href="#listCMS" aria-expanded="false" aria-controls="listCMS" class="collapsed">
	    ...
	    <div class="panel">
		    <div class="page-header" role="tab" id="cms">
			    <h2>
				    <a role="button" data-toggle="collapse" data-parent="#skills" href="#listTools" aria-expanded="false" aria-controls="listTools" class="collapsed">
					    Herramientas Web <i class="fa fa-arrow-circle-down" aria-hidden="true"></i></a>
			    </h2>
		    </div>
		    <div class="panel-collapse collapse" id="listTools" role="tabpanel" aria-labelledby="cms">
			    <div class="panel-body">
				    <?php
				    $args = array(
					    'post_type' => 'habilidades',
